...
#define FS				200				//Sampling freq in Hz
#define L				FS / 50			//Filter Length
#define ELAB			5				//elaboration window time in sec
#define	ELAB_BUF_SIZE	ELAB*FS
